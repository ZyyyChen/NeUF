...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        default="float",
        help=(
            "MHD element type to write for volume.mhd. The default keeps direct "
            "network intensities as float32; uint8 applies foreground min-max scaling."
        ),
    )
    parser.add_argument(
        "--save-volume-npy",
...
def load_baked_dataset(ckpt: dict):
    ...
    return Dataset.open_from_save(dataset_path), dataset_path
