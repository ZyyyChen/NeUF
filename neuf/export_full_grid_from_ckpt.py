...
# python -m neuf.export_full_grid_from_ckpt --ckpt latest/ckpt.pkl --output exports/full_grid
# python -m neuf.export_full_grid_from_ckpt --ckpt latest/ckpt.pkl --output exports/full_grid --recons-common-grid-h5 /home/zchen/Code/NeUF/exports/recons3d_style_cluster/03-04-2026/ckpt_3/recons_common_grid.h5
...
def load_dataset_from_ckpt(ckpt):
    ...
    return baked_dataset, dataset_path
...
def main():
    ...
    dataset.validate_checkpoint_dataset_geometry(
        ckpt,
        baked_dataset,
