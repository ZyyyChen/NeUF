...
DEFAULT_INPUT_DIR = "/home/zchen/Code/NeUF/data/simu_56"
# DEFAULT_OUTPUT_PATH = (
...
def parse_args():
    ...
    parser.add_argument("--img-folder", default="us", help="Relative folder containing input images")
    parser.add_argument("--info-folder", default="us", help="Relative folder containing infos.json")
    ...
    parser.add_argument(
        "--y2z",
        action="store_true",
        help="Convert input probe positions from a Y-up coordinate system to Z-up.",
    )
    parser.add_argument(
        "--exclude-valid",
        action="store_true",
